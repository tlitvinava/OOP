...
#             a = get_int_input("Length of side a: ", 1)
#             b = get_int_input("Length of side b: ", 1)
#             c = get_int_input("Length of side c: ", 1)

#         print("Enter the coordinates of the center of the triangle:")
#         center_x = get_int_input("Center x: ", 1, canvas.width)
#         center_y = get_int_input("Center y: ", 1, canvas.height)

#         # Создайте объект треугольника
#         triangle = Triangle(center_x, center_y, a, b, c)
#         canvas.draw_figure(triangle)
    ...
    while True:
        ...
        if choice == 1:
            ...
            if shape_choice == 1:
                ...
                # Создайте объект прямоугольного треугольника
                triangle = Triangle(x1, y1, base, height)
                canvas.draw_figure(triangle)
